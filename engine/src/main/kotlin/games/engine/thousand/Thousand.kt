...
class ThousandRound private constructor(
    ...
    /**
     * Что можно похвалить. Хвалить можно со взятки — с любой, начиная с
     * первой: марьяж объявляют уже за столом, а не на пустой стол. Хвалить
     * можно только той картой, которой сейчас вообще можно ходить, —
     * объявление и есть ход.
     */
