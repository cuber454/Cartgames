 ...
 *
 * Уровней три, и различить их можно одним словом — памятью. «Новичок»
 * кладёт что попало. «Обычный» смотрит только на свою руку: сбрасывает
 * тяжёлое и оставляет себе продолжения. «Хитрый» помнит всё, что вышло за
 * стол, и по невиданным костям считает, ответят ему или нет.
 *
 * Память здесь и есть сила, а не украшение: по прогону (KOZEL.md, 4.6)
 * каждый следующий уровень выигрывает у предыдущего около трёх четвертей
 * матчей. Никакого другого преимущества у него нет — подсмотреть ему
 * неоткуда, [KozelView] за этим и заведён.
 */
object KozelBot {
