...
object KozelBot {
     ...
     *  - **вес кости**: тяжёлое на руке — это очки проигравшего, и «рыба»
     *    закрывает раунд именно по ним;
    ...
    private fun score(view: KozelView, move: KozelMove.Place, memory: Boolean): Int {
        ...
        // Тяжёлое сбрасываем вдвойне охотнее: его очки на руке — единственное,
        // что записывает соперник.
